...
/**
 * 	Union type of parser or standard schema
 * @category Parsers
 * @since v0.0.1
 */
export type ParserOrSchema<T> = IConfigParser<T> | StandardSchemaV1<unknown, T>;
 ...
 * @since v0.0.1
 */
export type BaseParse<Out> = (value: string) => Awaitable<IResult<Out, TypeError>>;
 ...
 * @since v0.0.1
 */
export type ValidateResultOrSchema<Out> = BaseParse<Out> | StandardSchemaV1<unknown, Out>;

/**
 * Common parsers for config values
 * @category Parsers
 * @since v0.0.1
 */
export class KeyParser {
	 ...
	 * @param parser - Optional parser or standard schema to validate the string value.
	 * @returns  An IConfigParser that parses string values.
	 * @category Parsers
	 * @since v0.0.1
	 */
	...
	/**
	 * Boolean Config parser
	 * @param parser - Optional parser or standard schema to validate the boolean value.
	 * @returns  An IConfigParser that parses boolean values.
	 * @category Parsers
	 * @since v0.0.1
	 */
	...
	/**
	 * Integer Config parser
	 * @param parser - Optional parser or standard schema to validate the integer value.
	 * @returns  An IConfigParser that parses integer values.
	 * @category Parsers
	 * @since v0.0.1
	 */
	...
	/**
	 * Float Config parser
	 * @param parser - Optional parser or standard schema to validate the float value.
	 * @returns  An IConfigParser that parses float values.
	 * @category Parsers
	 * @since v0.0.1
	 */
	...
	/**
	 * BigInt Config parser
	 * @param parser - Optional parser or standard schema to validate the bigint value.
	 * @returns  An IConfigParser that parses bigint values.
	 * @category Parsers
	 * @since v0.0.1
	 */
	...
	/**
	 * URL Config parser
	 * @param parser - Optional parser or standard schema to validate the URL value.
	 * @returns  An IConfigParser that parses URL values.
	 * @category Parsers
	 * @since v0.0.1
	 */
	...
	static #protectedKeysObject<T extends object>(value: T, format: ValueLogFormat, keys: Set<keyof T>) {
